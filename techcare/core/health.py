"""
TechCare Bot - Health Check Module

Prüft System-Voraussetzungen und Konfiguration.
Wird verwendet von: techcare --health und Post-Update Smoke Test.
...
def run_health_check() -> int:
    ...
    console.print(f"\n[bold cyan]🩺 TechCare Health-Check v{__version__}[/bold cyan]\n")
    ...
    # 5. Daten-Verzeichnisse
    data_dir = Path("data")
    techcare_dir = Path.home() / ".techcare"
    for dir_path, name in [(data_dir, "data/"), (techcare_dir, "~/.techcare/")]:
        if dir_path.exists():
