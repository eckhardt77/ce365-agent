"""
TechCare Bot - Backup Creation Tools
...
class CreateRestorePointTool(RepairTool):
    ...
    def input_schema(self) -> Dict[str, Any]:
        return {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "description": "Beschreibung des Restore Points (Standard: TechCare Restore Point)",
                    "default": "TechCare Restore Point"
                }
            },
            "required": []
        }
    ...
    async def execute(self, **kwargs) -> str:
        ...
        Args:
            description: Beschreibung (default: "TechCare Restore Point")
