"""
CE365 Agent - CLI Update & Rollback Module

Sichert aktuelle Version vor Update und ermöglicht Rollback.
Backup-Verzeichnis: ~/.ce365/backups/v{version}/
"""
...
BACKUP_DIR = Path.home() / ".ce365" / "backups"


def run_update():
    """
    Aktualisiert CE365 CLI via pip.

    Flow:
    1. Aktuelle Version sichern
    2. pip install --upgrade ce365
    3. Health-Check
    ...
    console.print(f"\n[bold cyan]🔄 CE365 Update (aktuelle Version: v{__version__})[/bold cyan]\n")
